...
$(function () {
	...
	var area = new Morris.Area({
		...
		resize: true,
		data: [
			{y: '01', item1: sales_work_area[0].sales_1,  item2: sales_work_area[1].sales_1, item3: sales_work_area[2].sales_1, item4: sales_work_area[3].sales_1},
			{y: '02', item1: sales_work_area[0].sales_2,  item2: sales_work_area[1].sales_2, item3: sales_work_area[2].sales_2, item4: sales_work_area[3].sales_2},
			{y: '03', item1: sales_work_area[0].sales_3,  item2: sales_work_area[1].sales_3, item3: sales_work_area[2].sales_3, item4: sales_work_area[3].sales_3},
			{y: '04', item1: sales_work_area[0].sales_4,  item2: sales_work_area[1].sales_4, item3: sales_work_area[2].sales_4, item4: sales_work_area[3].sales_4},
			{y: '05', item1: sales_work_area[0].sales_5,  item2: sales_work_area[1].sales_5, item3: sales_work_area[2].sales_5, item4: sales_work_area[3].sales_5},
			{y: '06', item1: sales_work_area[0].sales_6,  item2: sales_work_area[1].sales_6, item3: sales_work_area[2].sales_6, item4: sales_work_area[3].sales_6},
			{y: '07', item1: sales_work_area[0].sales_7,  item2: sales_work_area[1].sales_7, item3: sales_work_area[2].sales_7, item4: sales_work_area[3].sales_7},
			{y: '08', item1: sales_work_area[0].sales_8,  item2: sales_work_area[1].sales_8, item3: sales_work_area[2].sales_8, item4: sales_work_area[3].sales_8},
			{y: '09', item1: sales_work_area[0].sales_9,  item2: sales_work_area[1].sales_9, item3: sales_work_area[2].sales_9, item4: sales_work_area[3].sales_9},
			{y: '10', item1: sales_work_area[0].sales_10, item2: sales_work_area[1].sales_10, item3: sales_work_area[2].sales_10, item4: sales_work_area[3].sales_10},
			{y: '11', item1: sales_work_area[0].sales_11, item2: sales_work_area[1].sales_11, item3: sales_work_area[2].sales_11, item4: sales_work_area[3].sales_11},
			{y: '12', item1: sales_work_area[0].sales_12, item2: sales_work_area[1].sales_12, item3: sales_work_area[2].sales_12, item4: sales_work_area[3].sales_12}
		],
		xkey: 'y',
		ykeys: ['item1', 'item2', 'item3', 'item4'],
		labels: [sales_work_area[0].name, sales_work_area[1].name, sales_work_area[2].name, sales_work_area[3].name],
		lineColors: ['#a0d0e0', '#3c8dbc', '#3c8dbc', '#3c8dbc'],
		hideHover: 'auto'
	});
