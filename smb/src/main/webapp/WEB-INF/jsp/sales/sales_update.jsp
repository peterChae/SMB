			...
			<div class="col-xs-12">
				<div class="box">
					...
					<div align="right" class="box-footer">
                		...
                		<button type="submit" id="fmBtnInsert" class="btn btn-info">데이터 수정</button>
              		</div>
              		<!-- /.box-footer -->
 ...
 */
$(function () {
	$("input#fmSalesMoney").val(${salesData.sales_money});
	$("input#fmAmtMoney").val(${salesData.amt_money});
	$("input#fmAmtKakaoMoney").val(${salesData.amt_kakao_money});
	$("input#fmNetSalesMoney").val(${salesData.net_sales_money});
	$("input#fmTargetCount").val(${salesData.target_count});
	$("input#fmPerformCount").val(${salesData.perform_count});
	$("input#fmRefundMoney").val(${salesData.refund_money});
	
	$("#fmWorkList option[value=${salesData.work_id}]").attr('selected', 'selected');
	$("#fmCmpyList option[value=${salesData.cmpy_id}]").attr('selected', 'selected');
	$("#fmBrandList option[value=${salesData.brand_id}]").attr('selected', 'selected');
	$("#fmAmtYear option[value=${salesData.amt_year}]").attr('selected', 'selected');
	$("#fmAmtMonth option[value=${salesData.amt_month}]").attr('selected', 'selected');
	$("#fmAmtTerm option[value=${salesData.amt_term}]").attr('selected', 'selected');
...
$('#fmBtnInsert').click(function() {
	...
	$.ajax({
		...
		data  : {
			     idx : ${salesData.idx},
			     work_id : $("#fmWorkList option:selected").val(),
